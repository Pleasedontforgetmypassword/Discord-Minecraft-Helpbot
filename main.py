...
# Facts command takes three arguments, itself, Type of info, e.g obtain, table, etc, The object's name.
@Bot.command(name='Fact', help=f'Usage: {COMMAND}Fact (Type of Info) (Name)')
async def Fact(ctx, arg1, *args):
    ...
    if len(text) >= 2000:
        ...
        embed.add_field(name='Failed to send',
                        value=f"Look The information That {ctx.author.mention} requested went over Discord's character limit, So here's the link: {url}")
...
async def explain(ctx):
    ...
    # Tells the user how to contact the developer
    embed.add_field(name="Contacts",
                    value="You can find the github page to this code at https://github.com/Pleasedontforgetmypassword/Discord-Minecraft-Helpbot")
